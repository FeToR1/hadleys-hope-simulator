    ...
    <main className="shell">
      ...
      <div className="content">
        <section className="workspace">
          ...
          {tab === 'map' ? <SettlementMap entities={entities} onSelect={selectEntity} /> : <NetworkTopology entities={entities} onSelect={selectEntity} />}
        </section>
        <Sidebar selected={selected} devices={devices} logs={logs} />
      </div>
    </main>
  );
}
