...
export function CausalChainTracker({ steps, onFocus }: CausalChainTrackerProps): JSX.Element {
  if (steps.length === 0) return <section className="causal-chain"><h3>Логика каскада событий</h3><p className="muted">Активных физических аварий нет.</p></section>;
