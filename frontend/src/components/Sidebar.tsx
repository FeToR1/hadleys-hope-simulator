...
export function Sidebar({ selected, devices, logs }: SidebarProps): JSX.Element {
  if (selected === undefined) {
    return <aside className="sidebar"><p className="muted">Выберите дом или узел на карте.</p></aside>;
  }
  return (
